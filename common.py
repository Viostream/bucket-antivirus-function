...
AV_OBJECT_IGNORE_PREFIX_LIST = os.getenv("AV_OBJECT_IGNORE_PREFIX_LIST")
AV_OBJECT_IGNORE_SUFFIX_LIST = os.getenv("AV_OBJECT_IGNORE_SUFFIX_LIST")
...
AV_STATUS_SLACK_PUBLISH_CLEAN = os.getenv("AV_STATUS_SLACK_PUBLISH_CLEAN", "True")
AV_STATUS_SLACK_PUBLISH_INFECTED = os.getenv("AV_STATUS_SLACK_PUBLISH_INFECTED", "True")
AV_STATUS_SLACK_WEBHOOK = os.getenv("AV_STATUS_SLACK_WEBHOOK")
